...
from model.IA import InterpositionAttention
import math
limit_a, limit_b, epsilon = -.1, 1.1, 1e-6

class AGCRNCell(nn.Module):
    def __init__(self, args, adj, node_num, hyper_model_dim, dim_in, dim_out, cheb_k, embed_dim, IA_emb, weight_decay=1., droprate_init=0.5, temperature=2./3.,
        ...
        self.args = args
        self.scale = 1e8
        self.att = InterpositionAttention(args, dim_in+self.hidden_dim, dim_in+self.hidden_dim, node_num, args.embed_dim, IA_emb, 0.15)
    ...
    def forward(self, x, state, node_embeddings, poly_coefficients, h):
        ...
        input_and_state = self.att(input_and_state)
